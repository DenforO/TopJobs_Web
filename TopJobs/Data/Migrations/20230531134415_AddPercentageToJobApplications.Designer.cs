...
namespace TopJobs.Data.Migrations
{
    ...
    [Migration("20230531134415_AddPercentageToJobApplications")]
    partial class AddPercentageToJobApplications
    {
            ...
            modelBuilder.Entity("TopJobs.Models.ApplicationUser", b =>
                {
                    b.HasOne("TopJobs.Models.Preference", "Preference")
                        .WithOne("User")
                        .HasForeignKey("TopJobs.Models.ApplicationUser", "PreferenceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("TopJobs.Models.JobAd", b =>
                {
                    ...
                    b.HasOne("TopJobs.Models.Preference", "Preference")
                        .WithOne("JobAd")
                        .HasForeignKey("TopJobs.Models.JobAd", "PreferenceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
